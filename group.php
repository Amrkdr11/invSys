	...
	<div class="col-md-12">
		...
		<div class="panel panel-default">
			<div class="panel-heading">
				<div class="page-heading"> <i class="glyphicon glyphicon-edit"></i> Manage Group</div>
			</div> <!-- /panel-heading -->
			<div class="panel-body">
				...
				<div class="div-action pull pull-right" style="padding-bottom:20px;">
					<button class="btn btn-success button1" data-toggle="modal" data-target="#addGroupModel"> <i class="glyphicon glyphicon-plus-sign"></i> Add Group </button>
				</div> <!-- /div-action -->				
				
				<table class="table table-hover table-striped table-bordered" id="manageGroupTable">
					<thead>
						<tr>							
							<th>Group Name</th>
							<th>Status</th>
    ...
    <div class="modal-content">
    	...
    	<form class="form-horizontal" id="submitGroupForm" action="php_action/createGroup.php" method="POST">
	      ...
	      <div class="modal-footer">
	        ...
	        <button type="submit" class="btn btn-success" id="createGroupBtn" data-loading-text="Loading..." autocomplete="off">Save Changes</button>
	      </div>
	      <!-- /modal-footer -->
     	</form>
	     <!-- /.form -->
